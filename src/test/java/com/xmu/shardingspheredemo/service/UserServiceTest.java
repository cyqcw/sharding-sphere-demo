...
public class UserServiceTest {
     ...
     * @return
     */
    private String[] getNameAndSex(String sex) {
    ...
    void generateUser() {
        for (int i = 0; i < 1000000; i++) {
            ...
            String[] nameSex = getNameAndSex(getSex());
            String name = familyName + nameSex[0];
            Integer age = getAge();
            userService.register(new UserDto(name, nameSex[1], age));
        }
    }
}
